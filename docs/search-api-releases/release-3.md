...
**Heading:**
> Components can work without AntD too.

**SubHeading:**
> Antd is a good and free components UI Kit. But what if we'll decide to use another library? It'll be hard to remove all imports, related to AntD because they're inside our components.
