...
const siteConfig = {
  title: 'Search API' /* title for your website */,
  tagline: 'Documentation',
  url: 'https://chickenkyiv.github.io' /* your website url */,
  baseUrl: '/search-api-documentation/' /* base url for your project */,
  // For github.io type URLs, you would set the url and baseUrl like:
  //   url: 'https://facebook.github.io',
  //   baseUrl: '/test-site/',

  // Used for publishing and more
  projectName: 'search-api-documentation',
  ...
  headerLinks: [
    ...
    {href : 'https://github.com/ChickenKyiv/search-api-documentation', label: 'GitHub'},
  ...
  // template. For example, if you need your repo's URL...
    repoUrl: 'https://github.com/ChickenKyiv/recipe-search-api',
};
